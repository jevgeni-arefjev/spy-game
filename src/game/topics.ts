...
export const TOPICS: readonly Topic[] = [
  {
    ...
    words: [
      ...
      { id: 'nightclub', hintId: 'loud' },
      { id: 'church', hintId: 'quiet' },
      { id: 'park', hintId: 'quiet' },
      { id: 'supermarket', hintId: 'loud' },
      { id: 'pharmacy', hintId: 'quiet' },
      { id: 'amusementPark', hintId: 'loud' },
      { id: 'courtroom', hintId: 'quiet' },
    ],
  },
  {
    id: 'professions',
    words: [
      ...
      { id: 'policeOfficer', hintId: 'risky' },
      { id: 'electrician', hintId: 'risky' },
      { id: 'miner', hintId: 'risky' },
      { id: 'sailor', hintId: 'risky' },
      { id: 'diver', hintId: 'risky' },
      { id: 'librarian', hintId: 'safe' },
      { id: 'accountant', hintId: 'safe' },
    ],
  },
  {
    id: 'food',
    words: [
      ...
      { id: 'tea', hintId: 'hot' },
      { id: 'kebab', hintId: 'hot' },
      { id: 'waffles', hintId: 'hot' },
      { id: 'lemonade', hintId: 'cold' },
      { id: 'yogurt', hintId: 'cold' },
      { id: 'oysters', hintId: 'cold' },
    ],
  },
  {
    id: 'entertainment',
    words: [
      ...
      { id: 'bowling', hintId: 'active' },
      { id: 'paintball', hintId: 'active' },
      { id: 'laserTag', hintId: 'active' },
      { id: 'theatre', hintId: 'relaxing' },
      { id: 'reading', hintId: 'relaxing' },
      { id: 'crossword', hintId: 'relaxing' },
      { id: 'birdwatching', hintId: 'relaxing' },
    ],
  },
  {
    id: 'travel',
    words: [
      ...
      { id: 'raceCar', hintId: 'fast' },
      { id: 'speedboat', hintId: 'fast' },
      { id: 'jetSki', hintId: 'fast' },
      { id: 'rocket', hintId: 'fast' },
      { id: 'tram', hintId: 'slow' },
      { id: 'canoe', hintId: 'slow' },
      { id: 'cableCar', hintId: 'slow' },
    ],
  },
  {
    id: 'sports',
    words: [
      { id: 'basketball', hintId: 'team' },
      { id: 'volleyball', hintId: 'team' },
      { id: 'hockey', hintId: 'team' },
      { id: 'rugby', hintId: 'team' },
      { id: 'baseball', hintId: 'team' },
      { id: 'cricket', hintId: 'team' },
      { id: 'waterPolo', hintId: 'team' },
      { id: 'handball', hintId: 'team' },
      { id: 'curling', hintId: 'team' },
      { id: 'rowing', hintId: 'team' },
      { id: 'tennis', hintId: 'solo' },
      { id: 'boxing', hintId: 'solo' },
      { id: 'golf', hintId: 'solo' },
      { id: 'swimming', hintId: 'solo' },
      { id: 'archery', hintId: 'solo' },
      { id: 'gymnastics', hintId: 'solo' },
      { id: 'skiing', hintId: 'solo' },
      { id: 'surfing', hintId: 'solo' },
      { id: 'marathon', hintId: 'solo' },
      { id: 'fencing', hintId: 'solo' },
      { id: 'climbing', hintId: 'solo' },
    ],
  },
]
